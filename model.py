...
if __name__ == "__main__":
    ...
    if config.model_name == "thesis1":
        model = create_thesis_model1()
    elif config.model_name == "thesis2":
        model = create_thesis_model2()
    elif config.model_name == "thesis3":
        model = create_thesis_model3()
