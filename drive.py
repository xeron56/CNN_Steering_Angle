...
out_name = "submissions/final_predictions.csv" ##[===o===]
...
print "Writing predictions..."  #producing final prediction file
...
predictions = pd.read_csv("submissions/final_predictions.csv") #prediction value fro test data
